            ...
            <div className="page-header min-vh-100">
                <div className="container">
                    <div className="row">
                                ...
                                <div className="card z-index-0">
                                    ...
                                    <div className="card-footer text-center pt-0 px-lg-2 px-1">
                                        <p className="mb-4 text-sm mx-auto">
                                            Não tem conta? {' '}
                                            <Link href={route('register')} className="text-primary text-gradient font-weight-bold">Registre-se</Link>
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="position-relative bg-gradient-primary h-100 m-3 px-7 border-radius-lg d-flex flex-column justify-content-center overflow-hidden" style={{backgroundImage: 'url("img/banner-dez23-03.webp")', backgroundSize: 'cover', backgroundPosition: 'center'}}>
