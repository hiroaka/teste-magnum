...
import CalculateDates from "@/Function/CalculateDates";
import Base from "@/Layouts/Base";
import Index from "@/Pages/Users/Index"; // ES2015

export default function Prescription2(props) {
    ...
    const renderAlerts = () => {
        ...
        alerts.map((alert) => items.push(<tr>
                        ...
                        <div className="card-body">
                            <div className="row">
                                ...
                                <div className="col-6">
                                    ...
                                    <button className="btn btn-primary" type="button" onClick={addAlert}>Adicionar
                                        Alerta
                                    </button>
                                    ...
                                    <div className={`${alertStage === 'frequency' ? '' : 'collapse'}`}>
                                        ...
                                        <button className="btn btn-primary" type="button" onClick={saveAlerts}>Salvar
                                        </button>
                                    </div>
...
Prescription.layout = (page) => <Base key={page} children={page} title={"Administrar prescrições do usuário"}/>
