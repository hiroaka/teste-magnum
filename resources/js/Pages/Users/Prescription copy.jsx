        ...
        return <>
            ...
            {medicines.filter((medicine) => onlyCategories.has(medicine.medicine_category_id) ).map((medicine) => <>
                <div className="form-check">
                    ...
                    type="checkbox" />
                    <label className="form-check-label" htmlFor={'medicine_id_'+medicine.id}>{medicine.name}</label>
                </div>
            </>) }
            {/* {JSON.stringify(userMedicines)  } */}
    ...
    const renderAlerts = () => {
        ...
        alerts.map((alert) => {
            ...
            days[whichArrray].items.push(<tr>
                         <td style={{backgroundColor: alert.color}}>{alert.name} { moment(alert.at).format(' HH:mm')}</td>
                     </tr>)
    ...
    return (
        ...
        <Dialog trigger={deleteAlertTrigger} title="Excluir alerta" size='modal-lg'>
            ...
            <div className="d-flex justify-content-center "></div>
                <button type="submit" onClick={()=>deleteAlert('left')} className="btn bg-gradient-danger ">Esquerdo</button>
                <button type="submit" onClick={()=>deleteAlert('right')} className="btn bg-gradient-danger ms-2">Direito</button>
        ...
        <Dialog trigger={deleteProgramTrigger} title="Excluir programa de colírio" size='modal-lg'>
            ...
            <div className="d-flex justify-content-center align-item-cent"></div>
                <button type="submit" onClick={()=>deleteProgram('left')} className="btn bg-gradient-danger ">Esquerdo</button>
                <button type="submit" onClick={()=>deleteProgram('right')} className="btn bg-gradient-danger ms-2">Direito</button>
