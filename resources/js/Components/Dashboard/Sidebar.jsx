        ...
        <aside className="sidenav bg-default navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 " id="sidenav-main">
            <div className="sidenav-header">
                ...
                <Link className="navbar-brand m-0" href={route('home')} target="_blank">
                    ...
                    <span className="ms-1 font-weight-bold"> ADMIN MCUNHA Moacir Cunha</span>
                </Link>
            </div>
                ...
                <ul className="navbar-nav">
                    <li className="nav-item">
                        <Link className={`${route().current('dashboard') && 'active'} nav-link`} href={route('dashboard')}>
                            ...
                            <span className="nav-link-text ms-1">Painel Admin</span>
                        </Link>
                    </li>
                    {/*<li className="nav-item mt-3">*/}
                    {/*    <h6 className="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Opções</h6>*/}
                    {/*</li>*/}
                    {/*<li className="nav-item">*/}
                    ...
                    {/*</li>*/}
                    <li className="nav-item mt-3">
                        <h6 className="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Cadastros</h6>
                    </li>
                    <li className="nav-item">
