...
export default function CreateUser({close, openPrescription}) {
            ...
            <form onSubmit={onSubmit}>
                ...
                <div className="modal-body">
                    ...
                    <div className="form-group" hidden={data.type === "admin"}>
                        <label htmlFor="birthday" className="col-form-label">Data de Nascimento:</label>
                        <MaskedInput
                            className="form-control" name='birthday' value={data.birthday}
                            onChange={onChange}
                            id="birthday"

                            mask={[/\d/, /\d/, '/', /\d/,/\d/, '/', /\d/, /\d/,/\d/,/\d/]}
                        />
                        {errors && <div className='text-danger mt-1'>{errors.birthday}</div>}
                    </div>
                    <div className="form-group" hidden={data.type === "admin"}>
